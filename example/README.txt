...
mv All.simplerepeatsnocov.part0.bed.gz example.bed.gz
```
...
mv Homo_sapiens.GRCh38.97.part0.gff3.gz example.gff3.gz
```
...
gzcat Homo_sapiens.GRCh38.dna.chromosome.*.fa.gz | dsh-bio truncate-fasta -l 250000 -o example.reference.fa.gz
```
...
mv Homo_sapiens.GRCh38.cds.all.part0.fa.gz example.transcript.fa.gz
```
...
mv Homo_sapiens.GRCh38.pep.all.part0.fa.gz example.protein.fa.gz
```
...
mv HG001.hs37d5.300x.21.part0.sam.gz example.sam.gz
```
...
mv homo_sapiens-chr21.part0.vcf.gz example.variant.vcf.gz
```
...
mv HG001_GRCh38_GIAB_highconf_CG-IllFB-IllGATKHC-Ion-10X-SOLID_CHROM1-X_v.3.3.2_highconf_PGandRTGphasetransfer.part0.vcf.gz example.genotype.vcf.gz
```
...
mv HGDP00125.hgdp_wgs.20190516.part0.vcf.gz example.gvcf.vcf.gz
```
